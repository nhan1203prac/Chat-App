...
router.post('/create', protectRoute, async (req, res) => {
    ...
    try {
        ...
        const fullGroupChat = await Conversation.findById(groupChat._id)
            .populate('participants', '-password') // Lấy thông tin user, bỏ password
            .populate('groupAdmin', '-password'); // Lấy thông tin admin, bỏ password
...
router.put('/add', protectRoute, async (req, res) => {
    ...
    try {
        ...
        // TODO: Gửi sự kiện socket tới các thành viên (bao gồm cả người mới) về việc thêm thành viên
...
// --- API Rời Nhóm ---
// @desc Người dùng tự rời khỏi nhóm
